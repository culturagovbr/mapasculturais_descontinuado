 ...
 */
class OpportunityAgentRelation extends \MapasCulturais\Entities\OpportunityAgentRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OpportunityAgentRelation $proxy) {
