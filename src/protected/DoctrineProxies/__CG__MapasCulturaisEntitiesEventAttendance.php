 ...
 */
class EventAttendance extends \MapasCulturais\Entities\EventAttendance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventAttendance $proxy) {
     ...
     * {@inheritDoc}
     */
    public function validateReccurrenceString()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'validateReccurrenceString', []);

        return parent::validateReccurrenceString();
    }

    /**
     * {@inheritDoc}
     */
    public function setReccurrenceString($recurrence_string)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReccurrenceString', [$recurrence_string]);

        return parent::setReccurrenceString($recurrence_string);
    }
