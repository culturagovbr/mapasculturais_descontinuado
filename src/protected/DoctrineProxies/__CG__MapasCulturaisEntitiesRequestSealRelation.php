 ...
 */
class RequestSealRelation extends \MapasCulturais\Entities\RequestSealRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestSealRelation $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setSealRelation(\MapasCulturais\Entities\SealRelation $relation)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSealRelation', [$relation]);

        return parent::setSealRelation($relation);
    }
