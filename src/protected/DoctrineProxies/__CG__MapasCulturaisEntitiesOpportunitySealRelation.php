 ...
 */
class OpportunitySealRelation extends \MapasCulturais\Entities\OpportunitySealRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'owner', 'id', 'objectId', 'createTimestamp', 'status', 'seal', 'agent', 'owner_relation', 'validateDate', 'renovation_request', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OpportunitySealRelation $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setSeal(\MapasCulturais\Entities\Seal $seal)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSeal', [$seal]);

        return parent::setSeal($seal);
    }
    ...
    public function getCertificateText($addLinks = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCertificateText', [$addLinks]);

        return parent::getCertificateText($addLinks);
    }
