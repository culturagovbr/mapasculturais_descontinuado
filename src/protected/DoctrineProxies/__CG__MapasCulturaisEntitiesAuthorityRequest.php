 ...
 */
class AuthorityRequest extends \MapasCulturais\Entities\AuthorityRequest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'ownerType', 'ownerId', 'objectType', 'objectId', 'createTimestamp', 'status', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AuthorityRequest $proxy) {
