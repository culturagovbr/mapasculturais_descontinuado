 ...
 */
class OpportunityPermissionCache extends \MapasCulturais\Entities\OpportunityPermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OpportunityPermissionCache $proxy) {
