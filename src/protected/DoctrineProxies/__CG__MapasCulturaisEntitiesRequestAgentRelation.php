 ...
 */
class RequestAgentRelation extends \MapasCulturais\Entities\RequestAgentRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'requestUid', 'originType', 'originId', 'destinationType', 'destinationId', 'createTimestamp', 'actionTimestamp', 'status', 'requesterUser', 'notifications', '__permissionsCache', 'metadata', '_validationErrors', '__skipQueuingPCacheRecreation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestAgentRelation $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setAgentRelation(\MapasCulturais\Entities\AgentRelation $relation)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAgentRelation', [$relation]);

        return parent::setAgentRelation($relation);
    }
