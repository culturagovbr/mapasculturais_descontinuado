 ...
 */
class ProjectTermRelation extends \MapasCulturais\Entities\ProjectTermRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectTermRelation $proxy) {
