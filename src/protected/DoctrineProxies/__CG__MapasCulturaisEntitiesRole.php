 ...
 */
class Role extends \MapasCulturais\Entities\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'user', 'subsiteId', 'subsite', '_validationErrors', '__enableMagicGetterHook'];
        }
     ...
     * {@inheritDoc}
     */
    public function setSubsiteId($subsite_id)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubsiteId', [$subsite_id]);

        return parent::setSubsiteId($subsite_id);
    }
     ...
     * {@inheritDoc}
     */
    public function is(string $role_name)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'is', [$role_name]);

        return parent::is($role_name);
    }
