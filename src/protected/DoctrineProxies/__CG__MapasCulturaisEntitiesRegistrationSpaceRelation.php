 ...
 */
class RegistrationSpaceRelation extends \MapasCulturais\Entities\RegistrationSpaceRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'owner', 'id', 'objectId', 'createTimestamp', 'status', 'space', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistrationSpaceRelation $proxy) {
