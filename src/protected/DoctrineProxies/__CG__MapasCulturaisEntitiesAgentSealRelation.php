 ...
 */
class AgentSealRelation extends \MapasCulturais\Entities\AgentSealRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AgentSealRelation $proxy) {
