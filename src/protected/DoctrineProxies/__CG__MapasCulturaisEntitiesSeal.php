 ...
 */
class Seal extends \MapasCulturais\Entities\Seal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Seal $proxy) {
     ...
     * {@inheritDoc}
     */
    public function validatePeriod($value)
    {
