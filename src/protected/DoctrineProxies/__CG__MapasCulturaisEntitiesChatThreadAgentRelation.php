 ...
 */
class ChatThreadAgentRelation extends \MapasCulturais\Entities\ChatThreadAgentRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChatThreadAgentRelation $proxy) {
