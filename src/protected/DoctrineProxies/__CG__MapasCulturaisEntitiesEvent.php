 ...
 */
class Event extends \MapasCulturais\Entities\Event implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '__enableMagicGetterHook', 'id', '_type', 'name', 'shortDescription', 'longDescription', 'rules', 'createTimestamp', 'status', 'occurrences', 'owner', 'project', '_relatedOpportunities', '__metadata', '__files', '__agentRelations', '__termRelations', '__sealRelations', '__permissionsCache', 'updateTimestamp', '_subsiteId', 'subsite', '' . "\0" . 'MapasCulturais\\Entities\\Event' . "\0" . '_newProject', '_validationErrors', '' . "\0" . 'MapasCulturais\\Entities\\Event' . "\0" . '_newOwner', '' . "\0" . 'MapasCulturais\\Entities\\Event' . "\0" . '__changedMetadata', '' . "\0" . 'MapasCulturais\\Entities\\Event' . "\0" . '__createdMetadata', '_avatar', 'terms', '__skipQueuingPCacheRecreation', '' . "\0" . 'MapasCulturais\\Entities\\Event' . "\0" . '__enabled'];
        }
    ...
    public function findOccurrencesBySpace(\MapasCulturais\Entities\Space $space, $date_from = NULL, $date_to = NULL, $limit = NULL, $offset = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'findOccurrencesBySpace', [$space, $date_from, $date_to, $limit, $offset]);

        return parent::findOccurrencesBySpace($space, $date_from, $date_to, $limit, $offset);
    }
    ...
    public function findOccurrences($date_from = NULL, $date_to = NULL, $limit = NULL, $offset = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'findOccurrences', [$date_from, $date_to, $limit, $offset]);

        return parent::findOccurrences($date_from, $date_to, $limit, $offset);
    }
    ...
    public function getRevisionData()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRevisionData', []);
