 ...
 */
class SpacePermissionCache extends \MapasCulturais\Entities\SpacePermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SpacePermissionCache $proxy) {
