 ...
 */
class AgentTermRelation extends \MapasCulturais\Entities\AgentTermRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AgentTermRelation $proxy) {
