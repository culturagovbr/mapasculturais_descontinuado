...
class Notification extends \MapasCulturais\Entities\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'createTimestamp', 'actionTimestamp', 'message', 'status', 'user', 'request', '__metadata', '__permissionsCache', '_validationErrors', '__enableMagicGetterHook', '__skipQueuingPCacheRecreation', '' . "\0" . 'MapasCulturais\\Entities\\Notification' . "\0" . '__enabled'];
        }
