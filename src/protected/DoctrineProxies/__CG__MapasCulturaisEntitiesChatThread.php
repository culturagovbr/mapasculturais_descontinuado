 ...
 */
class ChatThread extends \MapasCulturais\Entities\ChatThread implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChatThread $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getOwner(): \MapasCulturais\Entity
    {
     ...
     * {@inheritDoc}
     */
    public function getOwnerEntity(): \MapasCulturais\Entity
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOwnerEntity', []);
     ...
     * {@inheritDoc}
     */
    public function checkUserRole(\MapasCulturais\Entities\User $user, string $role)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'checkUserRole', [$user, $role]);

        return parent::checkUserRole($user, $role);
    }

    /**
     * {@inheritDoc}
     */
    public function highestRoleForUser($user)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'highestRoleForUser', [$user]);

        return parent::highestRoleForUser($user);
    }

    /**
     * {@inheritDoc}
     */
    public function sendNotifications(\MapasCulturais\Entities\ChatMessage $message)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'sendNotifications', [$message]);

        return parent::sendNotifications($message);
    }

    /**
     * {@inheritDoc}
     */
    public function setType(string $slug)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setType', [$slug]);

        return parent::setType($slug);
    }
