 ...
 */
class MetaList extends \MapasCulturais\Entities\MetaList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
  ...
  'description' => NULL,
    ...
    {
        unset($this->group, $this->title, $this->value, $this->description);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'group', 'title', 'value', 'description', 'objectType', 'objectId', 'createTimestamp', '_owner', '_validationErrors', '__enableMagicGetterHook'];
        }

        return ['__isInitialized__', 'id', 'objectType', 'objectId', 'createTimestamp', '_owner', '_validationErrors', '__enableMagicGetterHook'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MetaList $proxy) {
