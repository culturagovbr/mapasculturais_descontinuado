  ...
  'description' => NULL,
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'group', 'title', 'value', 'description', 'objectType', 'objectId', 'createTimestamp', '_owner', '_validationErrors'];
        }

        return ['__isInitialized__', 'id', 'objectType', 'objectId', 'createTimestamp', '_owner', '_validationErrors'];
    }
