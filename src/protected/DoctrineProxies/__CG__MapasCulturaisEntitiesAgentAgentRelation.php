 ...
 */
class AgentAgentRelation extends \MapasCulturais\Entities\AgentAgentRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AgentAgentRelation $proxy) {
