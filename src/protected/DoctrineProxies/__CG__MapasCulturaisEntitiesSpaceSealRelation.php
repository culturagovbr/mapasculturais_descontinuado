 ...
 */
class SpaceSealRelation extends \MapasCulturais\Entities\SpaceSealRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SpaceSealRelation $proxy) {
