 ...
 */
class Procuration extends \MapasCulturais\Entities\Procuration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '_token', 'action', 'user', 'attorney', 'createTimestamp', 'validUntilTimestamp', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Procuration $proxy) {
