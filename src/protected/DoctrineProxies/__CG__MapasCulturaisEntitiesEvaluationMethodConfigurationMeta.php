 ...
 */
class EvaluationMethodConfigurationMeta extends \MapasCulturais\Entities\EvaluationMethodConfigurationMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EvaluationMethodConfigurationMeta $proxy) {
