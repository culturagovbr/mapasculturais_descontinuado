 ...
 */
class EventSealRelation extends \MapasCulturais\Entities\EventSealRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventSealRelation $proxy) {
