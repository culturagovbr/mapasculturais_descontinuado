 ...
 */
class PermissionCachePending extends \MapasCulturais\Entities\PermissionCachePending implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'objectId', 'objectType', 'status', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PermissionCachePending $proxy) {
