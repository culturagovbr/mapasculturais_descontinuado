 ...
 */
class SealPermissionCache extends \MapasCulturais\Entities\SealPermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SealPermissionCache $proxy) {
