 ...
 */
class RequestSpaceRelation extends \MapasCulturais\Entities\RequestSpaceRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestSpaceRelation $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setSpaceRelation(\MapasCulturais\Entities\SpaceRelation $relation)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSpaceRelation', [$relation]);

        return parent::setSpaceRelation($relation);
    }
