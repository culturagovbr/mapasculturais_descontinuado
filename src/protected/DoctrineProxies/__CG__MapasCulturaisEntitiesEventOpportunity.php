 ...
 */
class EventOpportunity extends \MapasCulturais\Entities\EventOpportunity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
  ...
  'registrationFieldConfigurations' => NULL,
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventOpportunity $proxy) {
