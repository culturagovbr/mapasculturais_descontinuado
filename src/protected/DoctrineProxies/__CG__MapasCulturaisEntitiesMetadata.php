 ...
 */
class Metadata extends \MapasCulturais\Entities\Metadata implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'ownerId', 'ownerType', 'key', 'value', '_owner', '_validationErrors', '__enableMagicGetterHook'];
        }
