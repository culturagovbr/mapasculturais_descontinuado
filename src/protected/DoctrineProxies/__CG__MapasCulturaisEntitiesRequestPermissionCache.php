 ...
 */
class RequestPermissionCache extends \MapasCulturais\Entities\RequestPermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestPermissionCache $proxy) {
