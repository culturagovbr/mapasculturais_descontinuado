 ...
 */
class SpaceOpportunity extends \MapasCulturais\Entities\SpaceOpportunity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SpaceOpportunity $proxy) {
