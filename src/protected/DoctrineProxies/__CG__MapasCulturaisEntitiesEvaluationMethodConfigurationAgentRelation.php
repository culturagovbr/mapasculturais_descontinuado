 ...
 */
class EvaluationMethodConfigurationAgentRelation extends \MapasCulturais\Entities\EvaluationMethodConfigurationAgentRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EvaluationMethodConfigurationAgentRelation $proxy) {
     ...
     * {@inheritDoc}
     */
    public function reopen($flush = true)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'reopen', [$flush]);

        return parent::reopen($flush);
    }

    /**
     * {@inheritDoc}
     */
    public function disable($flush = true)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'disable', [$flush]);

        return parent::disable($flush);
    }

    /**
     * {@inheritDoc}
     */
    public function enable($flush = true)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'enable', [$flush]);

        return parent::enable($flush);
    }
