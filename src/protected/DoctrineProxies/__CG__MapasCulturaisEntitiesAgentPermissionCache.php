 ...
 */
class AgentPermissionCache extends \MapasCulturais\Entities\AgentPermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AgentPermissionCache $proxy) {
