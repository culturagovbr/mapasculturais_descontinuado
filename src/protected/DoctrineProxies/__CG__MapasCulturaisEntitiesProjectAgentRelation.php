 ...
 */
class ProjectAgentRelation extends \MapasCulturais\Entities\ProjectAgentRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectAgentRelation $proxy) {
