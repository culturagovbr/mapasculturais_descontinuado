 ...
 */
class EventTermRelation extends \MapasCulturais\Entities\EventTermRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventTermRelation $proxy) {
