 ...
 */
class NotificationMeta extends \MapasCulturais\Entities\NotificationMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NotificationMeta $proxy) {
