 ...
 */
class ProjectPermissionCache extends \MapasCulturais\Entities\ProjectPermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectPermissionCache $proxy) {
