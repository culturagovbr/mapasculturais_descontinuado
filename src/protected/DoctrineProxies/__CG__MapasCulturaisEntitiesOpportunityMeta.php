 ...
 */
class OpportunityMeta extends \MapasCulturais\Entities\OpportunityMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OpportunityMeta $proxy) {
