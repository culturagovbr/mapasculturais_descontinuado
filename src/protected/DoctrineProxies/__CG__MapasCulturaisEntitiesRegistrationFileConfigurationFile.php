 ...
 */
class RegistrationFileConfigurationFile extends \MapasCulturais\Entities\RegistrationFileConfigurationFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'owner', 'parent', 'id', 'md5', 'mimeType', 'group', 'name', '_path', 'description', 'private', 'createTimestamp', 'tmpFile', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistrationFileConfigurationFile $proxy) {
