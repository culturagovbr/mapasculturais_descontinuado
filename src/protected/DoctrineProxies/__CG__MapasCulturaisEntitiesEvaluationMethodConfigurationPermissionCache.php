 ...
 */
class EvaluationMethodConfigurationPermissionCache extends \MapasCulturais\Entities\EvaluationMethodConfigurationPermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EvaluationMethodConfigurationPermissionCache $proxy) {
