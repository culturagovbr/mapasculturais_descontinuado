 ...
 */
class EventPermissionCache extends \MapasCulturais\Entities\EventPermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventPermissionCache $proxy) {
