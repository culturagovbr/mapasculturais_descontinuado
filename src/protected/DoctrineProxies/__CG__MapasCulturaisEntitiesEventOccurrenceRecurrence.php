 ...
 */
class EventOccurrenceRecurrence extends \MapasCulturais\Entities\EventOccurrenceRecurrence implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'month', 'day', 'week', 'eventOccurrence', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventOccurrenceRecurrence $proxy) {
