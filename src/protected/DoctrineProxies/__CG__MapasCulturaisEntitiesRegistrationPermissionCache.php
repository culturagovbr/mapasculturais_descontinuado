 ...
 */
class RegistrationPermissionCache extends \MapasCulturais\Entities\RegistrationPermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistrationPermissionCache $proxy) {
