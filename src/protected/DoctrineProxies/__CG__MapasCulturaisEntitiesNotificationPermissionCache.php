 ...
 */
class NotificationPermissionCache extends \MapasCulturais\Entities\NotificationPermissionCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NotificationPermissionCache $proxy) {
