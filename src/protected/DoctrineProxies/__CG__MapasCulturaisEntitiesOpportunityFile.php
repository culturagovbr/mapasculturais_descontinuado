 ...
 */
class OpportunityFile extends \MapasCulturais\Entities\OpportunityFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OpportunityFile $proxy) {
