 ...
 */
class RegistrationFileConfiguration extends \MapasCulturais\Entities\RegistrationFileConfiguration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'owner', 'title', 'description', 'required', 'categories', 'displayOrder', '__files', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistrationFileConfiguration $proxy) {
    ...
    public function getFileGroupName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFileGroupName', []);

        return parent::getFileGroupName();
    }
