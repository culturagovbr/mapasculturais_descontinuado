 ...
 */
class EntityRevision extends \MapasCulturais\Entities\EntityRevision implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EntityRevision $proxy) {
