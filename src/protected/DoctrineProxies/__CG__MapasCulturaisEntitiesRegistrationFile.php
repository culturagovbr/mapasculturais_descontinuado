 ...
 */
class RegistrationFile extends \MapasCulturais\Entities\RegistrationFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistrationFile $proxy) {
