 ...
 */
class AgentOpportunity extends \MapasCulturais\Entities\AgentOpportunity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AgentOpportunity $proxy) {
