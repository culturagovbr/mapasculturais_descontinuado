 ...
 */
class UserApp extends \MapasCulturais\Entities\UserApp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '_publicKey', '_privateKey', 'user', 'name', 'status', 'createTimestamp', '_subsiteId', 'subsite', '_validationErrors', '__enableMagicGetterHook'];
        }
