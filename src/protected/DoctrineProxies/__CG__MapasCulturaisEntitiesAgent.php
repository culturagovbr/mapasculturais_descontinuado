 ...
 */
class Agent extends \MapasCulturais\Entities\Agent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '__enableMagicGetterHook', 'id', '_type', 'name', 'publicLocation', 'location', '_geoLocation', 'shortDescription', 'longDescription', 'createTimestamp', 'status', 'parent', '_children', 'user', 'userId', '_spaces', '_projects', '_ownedOpportunities', '_events', '_relatedOpportunities', '__metadata', '__files', '__agentRelations', '__termRelations', '__sealRelations', '__permissionsCache', 'updateTimestamp', '_subsiteId', 'subsite', '' . "\0" . 'MapasCulturais\\Entities\\Agent' . "\0" . '_newUser', '_validationErrors', '' . "\0" . 'MapasCulturais\\Entities\\Agent' . "\0" . '__changedMetadata', '' . "\0" . 'MapasCulturais\\Entities\\Agent' . "\0" . '__createdMetadata', '_avatar', 'terms', '__skipQueuingPCacheRecreation', '' . "\0" . 'MapasCulturais\\Entities\\Agent' . "\0" . '__enabled', '_newParent'];
        }
     ...
     * {@inheritDoc}
     */
    public function setAsUserProfile()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAsUserProfile', []);

        return parent::setAsUserProfile();
    }

    /**
     * {@inheritDoc}
     */
    public function setParentAsNull($flush = true)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setParentAsNull', [$flush]);

        return parent::setParentAsNull($flush);
    }

    /**
     * {@inheritDoc}
     */
    public function getIsUserProfile()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsUserProfile', []);

        return parent::getIsUserProfile();
    }
     ...
     * {@inheritDoc}
     */
    public function setOwner(\MapasCulturais\Entities\Agent $parent = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOwner', [$parent]);

        return parent::setOwner($parent);
    }
     ...
     * {@inheritDoc}
     */
    public function setUser(\MapasCulturais\Entities\User $user)
    {
     ...
     * {@inheritDoc}
     */
    public function setParent(\MapasCulturais\Entities\Agent $parent = NULL)
    {
    ...
    public function __setParent($args = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, '__setParent', [$args]);

        return parent::__setParent($args);
    }
     ...
     * {@inheritDoc}
     */
    public function nestedSetParent(\MapasCulturais\Entity $parent = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'nestedSetParent', [$parent]);

        return parent::nestedSetParent($parent);
    }
