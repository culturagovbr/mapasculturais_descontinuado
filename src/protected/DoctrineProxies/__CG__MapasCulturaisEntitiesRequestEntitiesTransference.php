 ...
 */
class RequestEntitiesTransference extends \MapasCulturais\Entities\RequestEntitiesTransference implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestEntitiesTransference $proxy) {
    ...
    public function setOrigin(\MapasCulturais\Entity $user)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrigin', [$user]);

        return parent::setOrigin($user);
    }
