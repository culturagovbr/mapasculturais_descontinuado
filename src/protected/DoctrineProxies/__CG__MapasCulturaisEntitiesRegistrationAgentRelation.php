 ...
 */
class RegistrationAgentRelation extends \MapasCulturais\Entities\RegistrationAgentRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistrationAgentRelation $proxy) {
