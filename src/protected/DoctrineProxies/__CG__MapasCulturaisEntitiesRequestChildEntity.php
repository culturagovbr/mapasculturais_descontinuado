 ...
 */
class RequestChildEntity extends \MapasCulturais\Entities\RequestChildEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestChildEntity $proxy) {
