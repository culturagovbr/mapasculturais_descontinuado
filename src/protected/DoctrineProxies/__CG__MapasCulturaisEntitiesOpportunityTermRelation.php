 ...
 */
class OpportunityTermRelation extends \MapasCulturais\Entities\OpportunityTermRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'owner', 'id', 'term', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OpportunityTermRelation $proxy) {
