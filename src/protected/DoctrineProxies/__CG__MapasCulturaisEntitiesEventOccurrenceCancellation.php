 ...
 */
class EventOccurrenceCancellation extends \MapasCulturais\Entities\EventOccurrenceCancellation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'date', 'eventOccurrence', '_validationErrors', '__enableMagicGetterHook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventOccurrenceCancellation $proxy) {
