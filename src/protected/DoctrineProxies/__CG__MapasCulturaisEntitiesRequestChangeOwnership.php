 ...
 */
class RequestChangeOwnership extends \MapasCulturais\Entities\RequestChangeOwnership implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestChangeOwnership $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setDestination(\MapasCulturais\Entity $agent)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDestination', [$agent]);

        return parent::setDestination($agent);
    }
