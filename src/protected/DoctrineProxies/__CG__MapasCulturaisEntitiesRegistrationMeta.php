 ...
 */
class RegistrationMeta extends \MapasCulturais\Entities\RegistrationMeta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegistrationMeta $proxy) {
