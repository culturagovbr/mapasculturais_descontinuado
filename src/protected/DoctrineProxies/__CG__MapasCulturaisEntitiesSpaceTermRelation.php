 ...
 */
class SpaceTermRelation extends \MapasCulturais\Entities\SpaceTermRelation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SpaceTermRelation $proxy) {
